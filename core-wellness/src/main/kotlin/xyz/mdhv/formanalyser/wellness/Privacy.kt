...
object PrivacyRegistry {
    val byTable: Map<String, PrivacyClass> = buildMap {
        ...
        put("goal", PrivacyClass.SHAREABLE); put("intervention", PrivacyClass.SHAREABLE); put("training_plan", PrivacyClass.SHAREABLE); put("session_context", PrivacyClass.SHAREABLE); put("session_default", PrivacyClass.SHAREABLE)
